...
//Power simulation with Round Robin VM allocation policy and Least CPU broker
object RoundRobinLeastPowerSimulation {
	private val logger = LoggerFactory.getLogger("RoundRobinLeastPowerSimulation")
