...
//Power simulation with Least Connection VM allocation policy and Random broker
object LeastConnectionRandomPowerSimulation {
	private val logger = LoggerFactory.getLogger("LeastConnectionRandmPowerSimulation")
