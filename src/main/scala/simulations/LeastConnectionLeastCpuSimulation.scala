...
//Simulation with Least Connection allocation, and Least CPU broker
object LeastConnectionLeastCpuSimulation {
	private val config = ConfigFactory.load()
	private val logger = LoggerFactory.getLogger("LeastConnectionLeastCpuSimulation")
